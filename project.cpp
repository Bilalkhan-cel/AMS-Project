...
private:
    ...
    void password(){
        ...
        clearScreen();
        cout << "=== UPDATE STUDENT PASSWORD ===" << endl << endl;
    ...
    void showstudents()
    {
        ...
        string a, b, c, d;
        cout << "-------------------------" << endl;
        cout << "   Showing All students   " << endl << endl;
    ...
    {
        clearScreen();
        cout << "=== ADD STUDENT MARKS ===" << endl << endl;
    ...
    {
        clearScreen();
        cout << "=== ADD STUDENT ATTENDANCE ===" << endl << endl;
